...
<style>
     body {
  background-image: url("https://4kwallpapers.com/images/walls/thumbs_3t/1950.jpg");
  background-size:100% ;
...
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-black fw-bold" style="background-color:#86efac; position: sticky; top: 0; z-index: 1000;" >
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Event<span style="color:#eab308;"><b>Yearly</b></span></a>
